  ...
  return (
    <div className='Bubbles'>
        <div>
          ...
          {BubbleArray.map(function(object, i) {return <div style={{zIndex:-1, backgroundColor:props.color, borderRadius:"100%", position:"fixed", left:object.left, bottom:object.bottom, width:object.size, height:object.size}} key={i}></div>;})}
        </div>
    </div>
  );
}
